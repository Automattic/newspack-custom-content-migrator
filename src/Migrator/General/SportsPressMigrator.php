...
class SportsPressMigrator implements InterfaceMigrator {
	...
	public function export_sportspress_contents( $output_dir, $output_file ) {
		// The \NewspackCustomContentMigrator\Migrator\General\PostsMigrator::export_posts automatically sets the PostsMigrator::META_KEY_ORIGINAL_ID meta.
