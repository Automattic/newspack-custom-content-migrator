...
class PostsMigrator implements InterfaceCommand {
	...
	public static function register_commands() {
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_export_posts' ),
			array(
		...
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_import_posts' ),
			array(
		...
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_export_all_staging_site_pages' ),
			array(
		...
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_import_staging_site_pages' ),
			array(
		...
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_delete_export_postmeta' ),
			array(
		...
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_find_posts_by_number_of_revisions' ),
			array(
		...
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_clear_revisions' ),
			array(
		...
		WP_CLI::add_command(
			...
			array( __CLASS__, 'cmd_clear_post_revisions' ),
			array(
		...
		WP_CLI::add_command(
			...
			[ __CLASS__, 'cmd_hide_featured_images' ],
			[
