...
class GutenbergBlockGenerator {
	...
	public function get_image( $attachment_post, $size = 'full', $link_to_attachment_url = true ) {
		...
		$content = '<figure class="wp-block-image size-' . $size . '">' . $a_opening_tag . '<img src="' . $image_url . '" alt="' . $image_alt . '" class="wp-image-' . $attachment_post->ID . '"/>' . $a_closing_tag . $caption_tag . '</figure>';
