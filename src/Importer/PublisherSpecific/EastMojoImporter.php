...
class EastMojoImporter implements InterfaceMigrator {
	...
	public function em_featured_image_data( $data, $post ) {
	...
	public function em_featured_image_import( $post_id, $post ) {
	...
	public function em_author_data( $data, $post ) {
	...
	public function em_author_import( $post_id, $post ) {
