...
class PostsMigrator implements InterfaceMigrator {
	...
	public function register_commands() {
		WP_CLI::add_command( 'newspack-live-migrate export-posts', array( $this, 'cmd_export_posts' ), [
		...
		WP_CLI::add_command( 'newspack-live-migrate import-posts', array( $this, 'cmd_import_posts' ), [
	...
	public function cmd_export_posts( $args, $assoc_args ) {
		...
		$this->export_posts( $post_ids_csv, $export_dir, $file_output_posts );
	 ...
	 * @param $post_ids_csv
	 * @param $export_dir
	 * @param $file_output_posts
	 */
	public function export_posts( $post_ids_csv, $export_dir, $file_output_posts ) {
